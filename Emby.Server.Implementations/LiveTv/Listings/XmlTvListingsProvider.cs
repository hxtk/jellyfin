    ...
    public class XmlTvListingsProvider : IListingsProvider
    {
        ...
        private static ProgramInfo GetProgramInfo(XmlTvProgram program, ListingsProviderInfo info)
        {
            ...
            var programInfo = new ProgramInfo
            {
                ...
                SeriesId = program.Episode == null ? null : program.Title.GetSHA1().ToString("N", CultureInfo.InvariantCulture)
            };
            ...
            if (string.IsNullOrWhiteSpace(program.ProgramId))
            {
                ...
                programInfo.ShowId = uniqueString.GetSHA1().ToString("N", CultureInfo.InvariantCulture);
